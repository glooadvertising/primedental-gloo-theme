        ...
        <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-16 lg:flex-1">
            ...
            <article id="<?php the_ID(); ?>" class="profile-card grid cursor-pointer">
                ...
                <div class="profile-info w-full grid px-2">
                    ...
                    <dialog id="<?php the_ID(); ?>" class="page-content px-4 md:px-12 pt-16 p-24 mt-4 lg:m-auto m-auto rounded-lg max-w-['calc(100% - 4rem)'] md:max-w-2xl !max-h-full bg-light-lavender text-lavender backdrop:bg-lavender/50"> 
                        <span>
