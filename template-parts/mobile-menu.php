<div id="mobile-menu" class="menu-visible menu-hidden flex items-center justify-center bg-lavender/90 backdrop-blur-md text-white z-30 rounded-xl lg:hidden ring-1 ring-inset ring-light-lavender/20">
