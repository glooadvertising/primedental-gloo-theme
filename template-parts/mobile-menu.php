<div id="mobile-menu" class="menu-visible menu-hidden flex items-center justify-center bg-gradient-to-tr from-light-lavender via-lavender to-lavender text-white z-30 rounded-xl lg:hidden">
