...
<footer id="colophon" class="bg-charcoal p-4 md:px-8 site-footer pt-8 pb-12" role="contentinfo">
	<?php do_action('tailpress_footer'); ?>

	<div class="pb-6 text-center text-white text-xs grid gap-8 sm:flex sm:justify-between uppercase border-b border-light-lavender/10">
		<a href="<?php echo get_bloginfo('url'); ?>" class="font-extrabold text-lg uppercase">
			<img src="<?php echo get_template_directory_uri(); ?>/resources/images/prime-dental_logo-inv.svg" alt="<?php echo get_bloginfo('name'); ?> Logo" class="w-28">
		</a>
	...
	<div class="text-light-lavender text-xs flex justify-between uppercase pt-6">
